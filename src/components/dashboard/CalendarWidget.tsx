...
const events = [
  { id: 1, time: "09:00", title: "School Drop-off", location: "Main Street Elementary", color: "hsl(var(--accent))", day: 14 },
  { id: 2, time: "10:30", title: "Team Standup", location: "Zoom", color: "hsl(200, 80%, 55%)", day: 14 },
  { id: 3, time: "13:00", title: "Lunch with Mom", location: "Café Roma", color: "hsl(340, 70%, 55%)", day: 14 },
  { id: 4, time: "15:30", title: "Piano Lesson", location: "Music Academy", color: "hsl(270, 60%, 55%)", day: 14 },
  { id: 5, time: "18:00", title: "Family Dinner", location: "Home", color: "hsl(var(--accent))", day: 14 },
  { id: 6, time: "08:00", title: "Gym", location: "FitLife", color: "hsl(200, 80%, 55%)", day: 10 },
  { id: 7, time: "11:00", title: "Dentist", location: "Dr. Smith", color: "hsl(340, 70%, 55%)", day: 11 },
  { id: 8, time: "16:00", title: "Soccer Practice", location: "City Park", color: "hsl(270, 60%, 55%)", day: 12 },
  { id: 9, time: "09:30", title: "Grocery Run", location: "Whole Foods", color: "hsl(var(--accent))", day: 15 },
  { id: 10, time: "14:00", title: "Book Club", location: "Library", color: "hsl(200, 80%, 55%)", day: 17 },
  { id: 11, time: "10:00", title: "Play Date", location: "Jake's House", color: "hsl(340, 70%, 55%)", day: 19 },
  { id: 12, time: "17:00", title: "Date Night", location: "Downtown", color: "hsl(270, 60%, 55%)", day: 21 },
];
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="mb-4 flex items-center justify-between">
        <h2 className="text-sm font-semibold uppercase tracking-widest text-accent">
          {view === "day" ? "Today's Schedule" : view === "week" ? "This Week" : MONTHS[currentMonth]}
        </h2>
...
const DayView = ({ today }: { today: number }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      {dayEvents.length === 0 && (
        <p className="py-8 text-center text-muted-foreground">No events today</p>
      )}
    </div>
  );
};
...
const WeekView = ({ today }: { today: number }) => {
  const weekStart = today - ((new Date().getDay() + 6) % 7); // Monday
    ...
    <div className="space-y-1">
      {weekDays.map((day, i) => {
        ...
        return (
          <div
            key={day}
            className={`rounded-lg p-3 transition-colors ${isToday ? "bg-secondary" : ""}`}
          >
      ...
      <div className="grid grid-cols-7 gap-1">
        {cells.map((day, i) => {
          ...
          return (
            <div
              key={i}
              className={`relative flex flex-col items-center rounded-md py-1.5 text-sm transition-colors ${
                isToday
